...
```{r, include = F}
key <- "761a6bbcd1807223968ec06d79e3fef3696fe574"
```

## Library
```{r}
census_api_key( key ) # load census api key
```
...
class_of_city <- cut(sant.sp@data$mhmval12, 10)
...
plot(sant.sp, col=my_colors ,  bg = "#FFFFFF")

# Use zoom library package to enlarge and save image
# zm()
```
